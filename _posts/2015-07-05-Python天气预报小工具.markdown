---
layout: post
title:  "Wepy--终端天气预报小工具"
categories: Python 
---


![weatherimage](http://wsfdl.oss-cn-qingdao.aliyuncs.com/weatherimage.png)

&nbsp;&nbsp;&nbsp;


Github 有位叫 [schachmat](https://github.com/schachmat) 的用户用 go 写了一个天气预报小工具 [wego](https://github.com/schachmat/wego)，效果非常棒，于是抱着好玩的心态用 Python 山寨一个类似工具 [wepy](https://github.com/DeliangFan/wepy)。实现不难，主要注意两点：

- Weather API：选择非常多，个人推荐 [openweathermap.org](http://openweathermap.org/)。
- Terminal color：参考了原作者的配色方案，以绿黄为主。

&nbsp;&nbsp;&nbsp;

![shanghai](http://wsfdl.oss-cn-qingdao.aliyuncs.com/weathershanghai.png)
