...
running sdist
running egg_info
creating koala.egg-info
writing koala.egg-info/PKG-INFO
...
creating dist
Creating tar archive
removing 'koala-2015.09.1' (and everything under it)

$ ls dist/
koala-2015.09.1.tar.gz
~~~
...
creating build/bdist.macosx-10.10-intel/wheel/koala-2015.09.1.dist-info/WHEEL

$ ls dist
koala-2015.09.1-py2-none-any.whl
~~~
...
$ ls dist
koala-2015.09.1-py2.py3-none-any.whl
~~~
...
2 . 把 koala.egg-info/PKG-INFO 上传至 [Pypi submit](https://pypi.python.org/pypi?%3Aaction=submit_form)，用于注册该项目。

~~~
$ cat koala.egg-info/PKG-INFO
Metadata-Version: 1.0
Name: koala
Version: 2015.09.1
Summary: A demo for python packaging.
Home-page: https://github.com/DeliangFan/koala
Author: vanderliang
